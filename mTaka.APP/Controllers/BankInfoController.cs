...
namespace mTaka.APP.Controllers
{
    public class BankInfoController : Controller
    {
        ...
        public dynamic Index(string data)
        {
            try
            {
                string url = ConfigurationManager.AppSettings["mTaka_server"] + "/api/BankInfo/GetAllBankInfo";
        ...
        public dynamic Create(string data)
        {
            try
            {
                ...
                string url = ConfigurationManager.AppSettings["mTaka_server"] + "/api/BankInfo/AddBankInfo";
        ...
        public dynamic Edit(string data)
        {
            try
            {
                string url = ConfigurationManager.AppSettings["mTaka_server"] + "/api/BankInfo/UpdateBankInfo";
                dynamic json = DataManipulation.SetObject(url, data);
                return json;
            }
            catch (Exception ex)
        ...
        public dynamic Delete(string data)
        {
            try
            {
                string url = ConfigurationManager.AppSettings["mTaka_server"] + "/api/BankInfo/DeleteBankInfo";
                dynamic json = DataManipulation.SetObject(url, data);
                return json;
            }
            catch (Exception ex)
        ...
        [HttpGet]
        //[CustomActionFilter]
        public dynamic GetBankInfoForDD()
        {
            try
            {
                string url = ConfigurationManager.AppSettings["mTaka_server"] + "/api/BankInfo/GetBankInfoForDD";
                var json = DataManipulation.SetObject(url, string.Empty);
                return json;
            }
            catch (Exception ex)
