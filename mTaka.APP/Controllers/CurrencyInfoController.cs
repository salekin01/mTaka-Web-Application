...
namespace mTaka.APP.Controllers
{
    public class CurrencyInfoController : Controller
    {
        ...
        public dynamic Index(string data)
        {
            try
            {
                string url = ConfigurationManager.AppSettings["mTaka_server"] + "/api/CurrencyInfo/GetAllCurrencyInfo";
        ...
        public dynamic Create(string data)
        {
            try
            {
                ...
                string url = ConfigurationManager.AppSettings["mTaka_server"] + "/api/CurrencyInfo/AddCurrencyInfo";
        ...
        public dynamic Edit(string data)
        {
            try
            {
                string url = ConfigurationManager.AppSettings["mTaka_server"] + "/api/CurrencyInfo/UpdateCurrencyInfo";
                dynamic json = DataManipulation.SetObject(url, data);
                return json;
            }
            catch (Exception ex)
        ...
        public dynamic Delete(string data)
        {
            try
            {
                string url = ConfigurationManager.AppSettings["mTaka_server"] + "/api/CurrencyInfo/DeleteCurrencyInfo";
                dynamic json = DataManipulation.SetObject(url, data);
                return json;
            }
            catch (Exception ex)
        ...
        #region DropDown
        [HttpGet]
        public dynamic GetCurrencyInfoForDD()
        {
            try
            {
